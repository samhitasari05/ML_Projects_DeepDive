# -*- coding: utf-8 -*-
"""Assignment4B_KNN_SamhitaSari.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HclLIvkomj-FOpWwiZ3zu0fwlhuGZnLs
"""

from google.colab import drive
drive.mount('/content/drive')

/#content/pima-indians-diabetes (1).csv
...
#df = pd.read_csv('/content/pima-indians-diabetes (1).csv', index_col=0)
#df = pd.read_csv('/content/drive/MyDrive/pima-indians-diabetes (1).csv', index_col=0)

df = pd.read_csv('/content/drive/MyDrive/AIT636/pima-indians-diabetes (1).csv', index_col=0)
