# -*- coding: utf-8 -*-
"""AIT636_Linear,Ridge,Lasso_Regression_Assignment3C.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zOlN6d2gY-9WAIuZw56wEJrWLkUNzZ4h
"""
...
for i in alpha_values:
    ...
    plt.show()
    # Report Overall Accuracy, precision, recall, F1-score
    # Whenever number is divided by zero, instead of nan, return 0
    print(metrics.classification_report(
    y_true=y_test,
    y_pred=predictions_test,
    target_names=list(map(str, class_names)),
